...
class PerformanceType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->addEventListener(FormEvents::SUBMIT, [$this, 'addPerformance']);
    }
    
    public function addPerformance(FormEvent $event) {
        $performance = $event->getData();
        ...
        /*$form
            ...
            ->add('resultat', EntityType::class, array(
                'class' =>Resultatcompetition::class,
                'choice_label' => 'resuNom',
                // used to render a select box, check boxes or radios
                'multiple' => false,
                'expanded' => false,
                'label' => 'Résultat de la compétition',
