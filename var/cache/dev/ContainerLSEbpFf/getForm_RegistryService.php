...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\AbsenceType' => function () {
    return ($this->privates['App\Form\AbsenceType'] ?? $this->privates['App\Form\AbsenceType'] = new \App\Form\AbsenceType());
}, 'App\\Form\\FichierType' => function () {
    return ($this->privates['App\Form\FichierType'] ?? $this->privates['App\Form\FichierType'] = new \App\Form\FichierType());
